...
class Solution {
    func reverse(_ x: Int) -> Int {
        ...
        while x != 0 {
            ...
            // Skip if multiplying by 10 and appending the digit would overflow Int32.max.
            //
            ...
            if reverse > maxBeforeMultiplyBy10 ||
               (reverse == maxBeforeMultiplyBy10 && digit > 7) {
                return 0
            }

            // Skip if multiplying by 10 and appending the digit would overflow Int32.min.
            //
            ...
            if reverse < minBeforeMultiplyBy10 ||
               (reverse == minBeforeMultiplyBy10 && digit < -8) {
                return 0
            }
